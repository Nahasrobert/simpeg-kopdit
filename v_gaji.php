                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="col-md-7 text-center hero-text">
                            <h1 data-aos="fade-up" data-aos-delay="">Data Gaji</h1>
                ...
                <div class="col-md-12 me-auto">
                    <table id="data-table-basic" style="width: 100%;" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $data = mysqli_query($con, "select * from gaji join pegawai on pegawai.id_pegawai=gaji.id_pegawai join jabatan on pegawai.id_jabatan=jabatan.id_jabatan where nip ='".$_SESSION['nip']."'");
