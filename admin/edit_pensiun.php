...
<div class="data-table-area">
    <div class="container">
        ...
        // include 'koneksi.php';
        $id = $_GET['id'];
        $data = mysqli_query($con, "select * from pensiun where id_pensiun='$id'");
        while ($d = mysqli_fetch_array($data)) {
        ?>
            <form method="post" action="update_pensiun.php" enctype="multipart/form-data">
                <input type="hidden" name="id_pensiun" value="<?php echo $d['id_pensiun']; ?>">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group ic-cmp-int">
                        ...
                        <div class="nk-int-st">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="date" required value="<?php echo $d['tgl_pensiun']; ?>" name="tgl_pensiun" class="form-control input-sm" placeholder="Tempat pensiun">
                                </div>
                            </div>
                        </div>
