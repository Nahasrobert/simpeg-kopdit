...
$html .= '<center><h2>Laporan Data Jabatan</h2></center>';
$html .= '<table class="table1">';
$html .= '<tr><th>No</th><th>Jabatan</th></tr>';
while ($d = mysqli_fetch_array($data)) {
    $html .= '<tr><td>' . $no++ . '</td><td>' . $d['jabatan'] . '</td></tr>';
}
$html .= '</table>';
$html .= '</body></html>';
...
$dompdf->stream('laporan-data-jabatan.pdf');
