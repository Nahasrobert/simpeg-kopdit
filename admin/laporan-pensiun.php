...
$no = 1;
$tahun = $_GET['tahun'];
$data = mysqli_query($con, "select * from pensiun join pegawai on pegawai.id_pegawai=pensiun.id_pegawai where YEAR(created_at_p) = '$tahun'");
...
$html .= '<center><h2>Laporan Data Pensiun Tahun '. $tahun . '&nbsp;' .'</h2></center>';    
