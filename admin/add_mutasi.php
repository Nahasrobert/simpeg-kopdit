...
<div class="data-table-area">
    <div class="container">
        <form method="post" action="aksi_mutasi.php" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group ic-cmp-int">
                    ...
                    <div class="nk-int-st">
                        <div class="form-group">
                            ...
                            <div class="nk-int-st">
                                <input type="text" required name="tmpt_mutasi" class="form-control input-sm" placeholder="Tempat Mutasi">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group ic-cmp-int">
                    ...
                    <div class="nk-int-st">
                        <div class="form-group">
                            ...
                            <div class="nk-int-st">
                                <input type="date" required name="tgl_mutasi" class="form-control input-sm" placeholder="Tanggal Mutasi">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group ic-cmp-int">
                    ...
                    <div class="nk-int-st">
                        <div class="form-group">
                            ...
                            <div class="nk-int-st">
                                <input type="file" name="sk_mutasi" required>
