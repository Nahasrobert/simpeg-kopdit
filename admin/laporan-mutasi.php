...
$no = 1;
$tahun = $_GET['tahun'];
$data = mysqli_query($con, "select * from mutasi join pegawai on pegawai.id_pegawai=mutasi.id_pegawai where YEAR(created_at_m) = '$tahun'");
...
$dompdf->stream('laporan-data-mutasi.pdf');
