...
$html .= '<center><h2>Laporan Data Pegawai</h2></center>';
$html .= '<table class="table1">';
$html .= '<tr><th>No</th><th>Nama</th><th>NIP</th><th>Jabatan</th><th>TTL</th><th>Jenis Kelamin</th><th>Pend Terakhir</th><th>Status</th></tr>';
while ($d = mysqli_fetch_array($data)) {
    $html .= '<tr><td>' . $no++ . '</td><td>' . $d['nama'] . '</td><td>'.$d['nip']. '</td><td>' . $d['jabatan'] . '</td><td>' . $d['tempat_lahir']. ', '.  $d['tgl_lahir'] . '</td><td>' . $d['jk'] . '</td><td>' . $d['pend_terakhir'] . '</td><td>' . $d['status'] . '</td></tr>';
}
$html .= '</table>';
$html .= '</body></html>';
