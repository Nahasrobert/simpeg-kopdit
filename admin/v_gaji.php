                                        ...
                                        <td>
                                            <div class="btn-toolbar" role="toolbar">
                                                <div class="btn-group notika-group-btn">
                                                    ...
                                                    <a href="del_gaji.php?id=<?php echo $d['id_gaji']; ?>" type="button" class="btn btn-danger notika-btn-danger btn-sm" onclick="return confirm('Yakin Data Akan Dihapus');"><i class="fa fa-trash-o "></i></a>
                                                </div>
