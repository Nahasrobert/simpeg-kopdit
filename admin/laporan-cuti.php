...
$tahun = $_GET['tahun'];
$no = 1;
$data = mysqli_query($con, "select * from cuti join pegawai on pegawai.id_pegawai=cuti.id_pegawai where YEAR(created_at_c) = '$tahun'");
...
$html .= '<center><h2>Laporan Data Cuti</h2></center>';
...
$dompdf->stream('laporan-data-cuti.pdf');
